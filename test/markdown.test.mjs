...
test("renders headings, emphasis, links, and inline code", () => {
  ...
  assert.match(html, /<a href="https:\/\/www\.voluchat\.com" rel="noopener noreferrer" target="_blank">VoluChat<\/a>/);
});
...
test("renders common block elements", () => {
  ...
  assert.match(html, /<blockquote><p>Automate the repeat questions first\.<\/p><\/blockquote>/);
  assert.match(html, /<ul><li>Catalog<\/li><li>Delivery<\/li><\/ul>/);
  assert.match(html, /<ol><li>Connect Instagram<\/li><li>Review answers<\/li><\/ol>/);
  assert.match(html, /<hr>/);
  assert.match(html, /<pre><code class="language-js">const channel = &#39;instagram&#39;;<\/code><\/pre>/);
});
