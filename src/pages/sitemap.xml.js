...
const STATIC_ROUTES = [
  ...
  { path: "/compare/aisensy", priority: "0.8" },
  { path: "/compare/respond-io", priority: "0.8" },
  { path: "/compare/chatfuel", priority: "0.8" },
  { path: "/compare/tidio", priority: "0.8" },
  { path: "/compare/zoko", priority: "0.8" },
  { path: "/alternatives", priority: "0.85" },
