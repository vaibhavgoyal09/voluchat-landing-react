...
export const metadata: Metadata = {
    ...
    description: "Learn how VoluChat collects, uses, and protects your data. Our commitment to privacy and data security for Indian Instagram sellers.",
    openGraph: {
        title: "Privacy Policy - VoluChat",
                ...
                <div className="prose prose-slate max-w-none">
                    <div className="bg-primary-50 border-l-4 border-primary-500 p-6 rounded-r-lg mb-8">
                        <p className="text-slate-700 font-medium mb-0">
                            At VoluChat, we take your privacy seriously. This policy explains how we collect, use, and protect your personal information.
                        </p>
                    </div>
                    ...
                    <section className="mb-10">
                        ...
                        <ul className="space-y-2 text-slate-700">
                            ...
                            <li><strong>Instagram Account Data:</strong> Instagram username, profile information, access tokens</li>
                            <li><strong>WhatsApp Business Data:</strong> WhatsApp Business number and related information</li>
                        ...
                        <ul className="space-y-2 text-slate-700">
                            ...
                            <li><strong>Instagram DM Data:</strong> Messages exchanged through our automation platform (to provide our service)</li>
                        </ul>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-700 mb-4">We do not sell your personal information. We may share your data with:</p>

                        <h3 className="text-xl font-semibold text-slate-800 mb-3">3.1 Service Providers</h3>
                        <ul className="space-y-2 text-slate-700">
                            <li><strong>Meta/Instagram:</strong> To provide Instagram automation features</li>
                            <li><strong>WhatsApp Business API:</strong> To enable WhatsApp integration</li>
                            <li><strong>Payment Processors:</strong> To process your payments securely</li>
                            <li><strong>Cloud Hosting:</strong> To store and process your data securely</li>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-700 mt-4">
                            To exercise these rights, contact us at <a href="mailto:privacy@voluchat.com" className="text-primary-600 hover:text-primary-700">privacy@voluchat.com</a>
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-700">
                            VoluChat is not intended for users under 18 years of age. We do not knowingly collect personal information from children. If you believe we have collected information from a child, please contact us immediately.
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-700">
                            Your data may be transferred to and processed in countries outside India. We ensure appropriate safeguards are in place to protect your data in accordance with this privacy policy and applicable laws.
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-700">
                            We may update this privacy policy from time to time. We will notify you of significant changes via email or through our platform. Your continued use of VoluChat after changes constitutes acceptance of the updated policy.
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <div className="bg-slate-50 p-6 rounded-lg">
                            <p className="text-slate-700"><strong>Email:</strong> <a href="mailto:privacy@voluchat.com" className="text-primary-600 hover:text-primary-700">privacy@voluchat.com</a></p>
                    ...
                    <div className="bg-slate-100 border border-slate-200 p-6 rounded-lg mt-12">
                        <p className="text-sm text-slate-600 mb-0">
                            <strong>Note:</strong> This privacy policy is designed to comply with Indian data protection laws and international best practices. By using VoluChat, you acknowledge that you have read and understood this policy.
                        </p>
                    </div>
                </div>
            </div>
