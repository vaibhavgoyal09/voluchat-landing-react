...
import { MessageSquare, Zap, Globe, BarChart3, Shield, Headphones } from "lucide-react";

export const metadata: Metadata = {
    title: "Features - VoluChat Instagram Automation Platform",
    description: "Explore VoluChat's powerful features: AI-powered DM automation, multi-language support, WhatsApp integration, analytics, and more for Indian sellers.",
    keywords: ["Instagram automation features", "DM automation", "WhatsApp integration", "Hindi chatbot", "Instagram analytics"],
    openGraph: {
        title: "Features - VoluChat Instagram Automation Platform",
        description: "Explore VoluChat's powerful features for Instagram sales automation",
    },
};
    ...
    const additionalFeatures = [
        {
            ...
            description: "AI-powered responses that understand context and intent. Reply to customer queries instantly in natural, human-like language.",
            benefits: [
        ...
        },
        {
            ...
            description: "Communicate with customers in their preferred language. Full support for Hindi and major Indian regional languages.",
            benefits: [
        ...
        },
        {
            ...
            description: "Automatically qualify leads based on purchase intent, budget, and engagement. Focus on high-value customers.",
            benefits: [
                "Smart lead scoring",
        ...
        },
        {
            ...
            description: "Track performance, measure engagement, and optimize your sales funnel with detailed insights and reports.",
            benefits: [
        ...
        },
        {
            ...
            description: "Bank-level encryption and security measures to protect your business data and customer information.",
            benefits: [
        ...
        },
        {
            ...
            description: "Get help when you need it with our dedicated Indian support team available via chat, email, and phone.",
            benefits: [
                "24/7 chat support",
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6">
                            Everything you need to <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-indigo-600">automate sales</span>
                        </h1>

                        <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
                            VoluChat combines powerful automation, intelligent AI, and seamless integrations to help Indian sellers scale their Instagram business effortlessly.
                        </p>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-3xl mx-auto text-center mb-16">
                        ...
                        <p className="text-lg text-slate-600">
                            Every feature is designed with the unique needs of Indian D2C brands and Instagram sellers in mind.
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        <div className="bg-white rounded-2xl p-8 text-center border border-slate-200">
                            ...
                            <p className="text-slate-600">Direct integration with Instagram DMs and comments</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 text-center border border-slate-200">
                            ...
                            <p className="text-slate-600">Seamless handoff to WhatsApp for closing sales</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 text-center border border-slate-200">
                            ...
                            <h3 className="text-xl font-bold text-slate-900 mb-2">Custom Integrations</h3>
                            <p className="text-slate-600">Connect with your CRM, analytics, and more</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-3xl mx-auto text-center text-white">
                        ...
                        <p className="text-xl mb-8 text-primary-50">
                            Join 500+ Indian sellers already using VoluChat to automate their sales and grow their business.
                        </p>
                        <Link
                            href="/#get-started"
