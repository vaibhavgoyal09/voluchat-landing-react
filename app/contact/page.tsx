...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with VoluChat. Our support team is here to help with Instagram automation, technical issues, and sales inquiries.",
  openGraph: {
    title: "Contact Us - VoluChat Support",
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-16">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-purple-600 font-medium text-sm">India 🇮🇳</p>
            </div>
          </div>
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-slate-600">
                    I agree to receive communications from VoluChat and
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-slate-600">
                    <p>
                      <strong>Email Support:</strong> 24/7 (Response within 24
                      hours)
                    </p>
                    <p>
                      <strong>Live Chat:</strong> Monday - Saturday, 9:00 AM -
                      9:00 PM IST
                    </p>
                    <p>
                      <strong>Phone Support:</strong> Monday - Friday, 9:00 AM -
                      6:00 PM IST
                    </p>
                    <p className="text-sm text-slate-500 mt-4">
                      * Premium and Enterprise customers receive priority 24/7
                      support
                    </p>
                  </div>
                </div>
