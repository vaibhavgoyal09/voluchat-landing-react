      ...
      <div className="container-padding">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12 pb-12 border-t border-slate-100">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  href="https://careers.voluchat.com"
                  className="text-slate-600 hover:text-primary-600 transition-colors text-sm"
                >
                  Careers
                </a>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-slate-100">
          ...
          <div className="flex gap-6">
            <a
              href="https://twitter.com/voluchat"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/company/voluchat"
              target="_blank"
              rel="noopener noreferrer"
              className="text-slate-400 hover:text-primary-600 transition-colors"
            >
            ...
            <a
              href="https://instagram.com/voluchat"
              target="_blank"
              rel="noopener noreferrer"
              className="text-slate-400 hover:text-primary-600 transition-colors"
            >
