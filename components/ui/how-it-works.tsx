...
const StepCard: React.FC<StepCardProps> = ({
    ...
    >
        ...
        <h3 className="mb-3 text-2xl font-heading font-bold text-slate-900">{title}</h3>
        <p className="mb-8 text-slate-600 leading-relaxed font-medium text-lg">{description}</p>
        {/* Benefits List */}
...
export const HowItWorks: React.FC<HowItWorksProps> = ({
    ...
    const stepsData = [
        ...
        },
        {
            ...
            title: "Automate",
            description:
                "VoluChat replies instantly and sends leads to WhatsApp.",
            benefits: [
    ...
    return (
        <section
            id="how-it-works"
            className={cn("w-full py-16 sm:py-24 relative overflow-hidden", className)}
            {...props}
        >
            {/* Background Elements */}
