        ...
        <div className="flex flex-col text-center bg-white/80 backdrop-blur-xl border border-white/50 rounded-[2.5rem] p-8 lg:p-20 gap-10 items-center relative overflow-hidden shadow-2xl">
          ...
          <div className="flex flex-col gap-6 relative z-10">
            ...
            <p className="text-xl leading-relaxed tracking-tight text-slate-600 max-w-2xl font-medium mx-auto">
              Join hundreds of Indian sellers who automated their DMs and
              WhatsApp follow-ups. Setup takes 15 minutes.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-5 relative z-10 w-full sm:w-auto">
            <Button
              className="gap-2 h-14 px-8 text-lg rounded-full bg-slate-900 hover:bg-slate-800 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
              size="lg"
            >
              Start Free Trial <MoveRight className="w-5 h-5" />
            </Button>
            <Button
              className="gap-2 h-14 px-8 text-lg rounded-full bg-white border-slate-200 text-slate-900 hover:bg-slate-50 hover:border-slate-300 shadow-sm"
              variant="outline"
              size="lg"
            >
