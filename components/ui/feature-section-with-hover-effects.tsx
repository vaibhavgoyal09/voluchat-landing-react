...
export function FeaturesSectionWithHoverEffects() {
    const features = [
        ...
        },
        {
            ...
            description: "Built to respect Instagram and WhatsApp guidelines – no shady bots.",
            icon: <IconCloud />,
        },
        {
            title: "Analytics that Track Real Sales",
            description: "See how many DMs turned into orders and which flows perform best.",
